...
RATE_LIMIT_WINDOW_SECONDS = int(_env_str("RATE_LIMIT_WINDOW_SECONDS", "600"))
RATE_LIMIT_BLOCK_SECONDS = int(_env_str("RATE_LIMIT_BLOCK_SECONDS", "900"))
ADMIN_LOGIN_RATE_LIMIT_MAX_ATTEMPTS = int(_env_str("ADMIN_LOGIN_RATE_LIMIT_MAX_ATTEMPTS", "5"))
USER_LOGIN_RATE_LIMIT_MAX_ATTEMPTS = int(_env_str("USER_LOGIN_RATE_LIMIT_MAX_ATTEMPTS", "10"))
PASSWORD_RESET_RATE_LIMIT_MAX_ATTEMPTS = int(_env_str("PASSWORD_RESET_RATE_LIMIT_MAX_ATTEMPTS", "5"))

SQLITE_BUSY_TIMEOUT_MS = int(_env_str("SQLITE_BUSY_TIMEOUT_MS", "5000"))
